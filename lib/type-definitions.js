 ...
 * @property {boolean}                            [stripPrefix=true]    - Whether it should prefix be stripped from start of field name
 * @property {boolean}                            [stripSuffix=true]    - Whether it should suffix be stripped from end of field name.
 */
const ruleConfigSchema = {
  ...
  stripSuffix:    Joi.boolean().default(true),
};
