 ...
 * @property {boolean}                            [stripPrefix]         - Whether it should prefix be stripped from start of field name
 * @property {boolean}                            [stripSuffix]         - Whether it should suffix be stripped from end of field name.
 */
const ruleConfigSchema = {
  ...
  stripPrefix:    Joi.boolean().optional(),
  stripSuffix:    Joi.boolean().optional(),
};
